...
"decompose_insar_velocities" is an open-source set of matlab scripts for performing a velocity decomposition (e.g. Watson et al. 2022, and references therein) on multiple overlapping InSAR velocity fields.
...
This is research code provided to you "as is" with no warranties of correctness. Users do so at their own risk.
...
This work was completed while completing a PhD at the University of Leeds, School of Earth and Environment, funded by the Royal Society.
